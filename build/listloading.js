...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
      ...
      function Listloading(element, options) {
          ...
          var id   = this.ele.getAttribute('id');
          // 如果没有ID 则自动创建一个id
          if (!id) {
      ...
      Listloading.prototype = {
          ...
          init: function (options) {
              ...
              // 显示区域高度
              this.options.viewHeight        = parseFloat(getComputedStyle(this.ele).height) ;//[flag][yes]
              ...
              // 继承
              _util.deepExtend(this.options, options);//[flag][yes]
              // 执行render
              this.render();
          },
          // 入口
          ...
          destroy: function () {
              // 删除上拉下拉刷新节点//[flag][yes]
              this.children.style.WebkitTransform = '';
          ...
          createPullUpEle: function (refresh) {
              ...
              var op             = this.options;
              var children       = this.children;//[flag][yes]
              children.style.minHeight = 'auto';
  
              var childrenHeight = parseFloat(getComputedStyle(children).height) ;//[flag][yes]
              ...
              if (this.pullUpEle) {
                  ...
                  if(childrenHeight < op.minScrollHeight){
                      ...
                      // 设置最小滚动高度
                      children.style.minHeight = op.minScrollHeight ;//[flag][yes]
                  }
              } else {
                  ...
                  if(_util.isFunction(op.pullUpAction) && childrenHeight > op.minScrollHeight){
                      ...
                      // 设置最小滚动高度
                      children.style.minHeight = op.minScrollHeight;
                  }
              }
              if (iscroll) {
          ...
          createPullIScroll: function () {
              ...
              // 下拉加载更多//[flag][yes]
              var pullDownEle = _util.parseStringToHTML('<div id="' + this.pullDownId + '" data-class="pullDownId">' + 
          ...
          scrollEvent: function () {
              ...
              iscroll.on('scrollStart', function () {
                  ...
                  // 上拉
                  else if (pullUpEle && _util.hasClass(pullUpEle,'loading')) {
                      // 设置class和提示
              ...
              iscroll.on('scrollMove', function(){
                  ...
                  var pullUpEle      = self.pullUpEle;
                  var gapY           = 5;  // 拖动的距离
                  var pullDownEleCls = _util.hasClass(pullDownEle,'flip');//[flag][yes]
                  var pullUpEleCls   = pullUpEle && _util.hasClass(pullUpEle,'flip');//[flag][yes]
          ...
          pullDownAction: function (flag) {
              ...
              var id                = document.getElementById(self.id);//[flag][yes]
              ...
              if (_util.isFunction(pullDownAction)) {
                  ...
                  if (intervals >= 400) {
                      publishEvents.listen(pullDownActionStr, function(){
                          ...
                          // 加载完毕让动画停留1秒
                          setTimeout(function () {
                              document.body.classList.remove('iscroll');//[flag][yes]
                              // 复位动画
                              self.resizeAnimate();
                      ...
                      pullDownAction(function () {
                          // 加载中禁止拖动
                          document.body.classList.add('iscroll');//[flag][yes]
                          // 执行订阅方法
                          publishEvents.trigger(pullDownActionStr);
                      }, flag);
                  }
                  ...
                  if (intervals >= 400){
                      publishEvents.listen(pullUpActionStr, function(){
                          ...
                          if( op.pullEnd ){
                              ...
                              document.body.classList.remove('iscroll');
                              loaderText = op.upLoadmoretxt;
                              // 数据加载完成后，调用界面更新方法
                              iscroll.refresh();
                          }
                          // 显示加载完毕文字
                          pullUpEle.querySelector('.pullUpLabel').innerHTML = loaderText;
